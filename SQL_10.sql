...
SELECT NOME, IDADE, CPF, ENDERECO1, BAIRRO, CIDADE FROM tbcliente WHERE (idade BETWEEN 15 AND 23) AND SEXO = 'M';
...
INSERT INTO tbproduto (PRODUTO, NOME_PRODUTO, EMBALAGEM, TAMANHO, SABOR, PRECO_LISTA)
...
INSERT INTO tbvendedores (MATRICULA, NOME, PERCENTUAL_COMISSAO) 
VALUES('00235', 'MARCIO ALMEIDA SILVA', 0.8);
INSERT INTO tbvendedores (MATRICULA, NOME, PERCENTUAL_COMISSAO) 
VALUES('00236', 'CLAUDIA MORAIS', 0.8);

UPDATE tbvendedores SET PERCENTUAL_COMISSAO = 11 WHERE MATRICULA = '00236';

UPDATE tbvendedores SET NOME = 'JOSE GERALDO DA FONSECA JUNIOR' WHERE MATRICULA = '00233';
...
VALUES('00235', 'Marcio Almeida Slva', 0.8, '2014-08-15', 0);

INSERT INTO tbvendedores (MATRICULA, NOME, PERCENTUAL_COMISSAO, DATA_ADMISSAO, DE_FERIAS)
VALUES('00236', 'Claudia Morais', 0.8, '2013-09-17', 1);
...
# CONSULTAS NO BANCO DE DADOS CRIADO

SELECT NOME, CPF, IDADE, CIDADE, ESTADO, LIMITE_CREDITO, VOLUME_COMPRA FROM tbcliente;

SELECT NOME, MATRICULA FROM tbvendedores;

SELECT * FROM tbvendedores WHERE MATRICULA = '00236';

SELECT * FROM tbvendedores WHERE  Percentual_comissao BETWEEN 0.10 AND 0.20;
